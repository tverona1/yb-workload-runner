...
from simple_workload import SimpleTenantApp
...
class Main:
    ...
    def parse_arguments(self):
        parser = argparse.ArgumentParser(description='Metadata Scalability')
    ...
    def main(self):
        ...
        if (args.command == 'setup'):
            ...
            workload_runner = Executor(cluster_helper, [SimpleTenantApp])
